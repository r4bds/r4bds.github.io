...
- [Primer on R Packages](primer_on_r_packages.qmd#pkgwf)
...
The exercises uses what you learned in [Lab 7](lab07.qmd) and its [exercises](lab07.qmd#sec-exercises).
...
6. Create an MIT license (from the console) `usethis::use_mit_license("Group name")`
7. <details>
