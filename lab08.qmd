...
- Book: [R Packages (2e): Chapter 1 Introduction](https://r-pkgs.org/introduction.html)
- Book: [R Packages (2e): Chapter 1 The Whole Game](https://r-pkgs.org/whole-game.html)
- Video: [Building R packages with devtools and usethis | RStudio](https://www.youtube.com/watch?v=EpTkT6Rkgbs) (This is optional and is basically a video walk-through of the reading material)
