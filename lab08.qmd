...
Restart R, clean your Environment (small broom in the Environment tab), run the three lines of code from [The Package Workflow](#pkgwf) section, and run `?NAME_OF_YOUR_OBJECT`. Your manual should pop up. Try printing the object as well to see what it looks like `print(NAME_OF_YOUR_OBJECT)`.
