...
- Create a new Quarto Document for today's exercises, e.g. `lab04_exercises.qmd`
...
*Understanding how paths and projects work is important. In case this is not entirely clear, a new chapter has been added on [Paths and Projects](paths_and_projects.qmd).*
...
**Try to structure your Quarto document as your course notes, i.e. add notes while solving the exercises aiming to create a reference that you can revisit for your final project work.**
...
* **Q18: What correlates better with `BMI`, `WHR` or `BFP`?** <span style="color: red;">GROUP ASSIGNMENT</span>
