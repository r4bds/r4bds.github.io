...
To add a file to the staging area, you `git add <file_path_1> <file_path_2> ...`. This is the equivalent of ticking the check 
boxes of the *Staged* column in the Git tab of Rstudio.
...
In the terminal you can get the nice visualization with `git diff --staged` and once you have reviewed it, you can commit by running
