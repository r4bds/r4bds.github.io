...
-   08.00 - 09.15: Arrival and 5 min. pre-course anonymous survey: Click here to answer
-   09.15 - 09.30: Lecture: [Course Introduction](lecture_lab01.qmd)
-   09.30 - 10:00: Up and Running
    -   Group Formation
    -   Cloud computing using RStudio Cloud
-   10.00 - 10.15 Break
-   10.15 - 11.15: Exercises: [Virtual AI Assistant](virtual_ai_assistant.qmd)
-   11.15 - 11.30 Break
-   11.30 - 12.00: Reproducibility and Replicability in modern Bio Data Science
...
The source is where you will write scripts. A script is a series of commands to be executed sequentially. Right now, you should have a open script called `Untitled1`. If not, you can create a new script by clicking white paper with a round green plus sign in the upper left corner.
...
I am pretty sure you all know of chatGPT, so let us address the elefant in the room!
...
1. *Give a few fun examples on how to get started with the R programming language using dna*
...
**Therefore, in the beginning of the course, for your own sake, please refrain from using chatGPT. Instead solve the exercises based on the materials you have prepared, talk to you group members and discuss the challenges and check your understanding**
