...
1. **HOW TO HAND IN**: Go to `http://github.com/rforbiodatascienceYY/groupXX`, replace `YY` with year and `groupXX` with appropriate group number, then copy the link and paste it into an empty text (.txt) file. Hand in this text file.
