...
1. Again, create a reproducible micro-report, this time, where you do a code-along
...
*Note, focus here is on the `git` learning objectives, so focus less on fancy plots and more on `git`, while reproducing the post into a nice concise tidy micro-report!*
