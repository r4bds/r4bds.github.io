...
1. Again, create a micro-report, this time, where you do a code-along
...
*Note, focus here is on the `git` learning objectives, so focus on those while reproducing the post into a nice micro-report!*
