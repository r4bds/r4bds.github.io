...
<span style="color: red;">**Be aware of where you are working at! You should work on "Visual" editor instead of "Source" editor. ALL OF YOU! If one of you work on different editor, it could cause a conflict issue!**</span>
...
1. In the `group_document.qmd` under your section, using markdown, enter a new sub-header and name it e.g. `New feature` or `New analysis`. Make sure that you are all on the Visual editor for the qmd!
...
1. Use your GitHub group repository to collaborate. Make sure again that you are on the "Visual" editor for working on this!
