...
1. Make sure that you can see the `lab07_git_exercises.Rproj` and `.gitignore` files in the GitHub repository before proceeding further
...
4. Log into GitHub if not logged in already
