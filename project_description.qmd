...
Where directories left-to-right and corresponding files are:

- `_raw`: Contains your raw data file, which must **never** be edited
...
- `data`:
  - `_raw`: The directory containing your raw data
...
- `R`: Contains your Quarto Documents and project script
...
- `results`: Contains anything considered a result, i.e. plots, p-value tables, differentially expressed genes, etc
...
- `doc`: Anything considered a document, a PDF of your paper and here, also your final presentation
...
Yes, we are not putting the data on GitHub, so either include programmatic retrieval of the data or state in your GitHub README file, how you retrieved the data forming the base of the project.K
