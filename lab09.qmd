...
Please walk through everything you do.
...
In the end, you can just abandon this project and create a new based on the updated GitHub repository - up to you, but expect a headache if you try to pull/push a version you have edited to the one another has edited as well.
